...
import { Shield, User, Activity, Calendar, Clock, TrendingUp } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-slate-600 mt-2">Welcome back, {userData?.fullName || 'User'}!</p>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Avg {avgDaily.toFixed(1)}h/day</p>
            </CardContent>
          </Card>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your online time over the past week</CardDescription>
            </CardHeader>
            <CardContent>
